...
# data
cnv_filename = 'train_cnv.csv'
response_filename = 'train_label.csv'
gene_important_mutations_only = 'train_mut.csv'

gene_final_no_silent_no_intron = '0.csv'
gene_important_mutations_only_plus_hotspots = '0.csv'
gene_hotspots = '0.csv'
gene_truncating_mutations_only = '0.csv'
gene_expression = '0.csv'
fusions_filename = '0.csv'
cnv_burden_filename = '0.csv'
fusions_genes_filename = '0.csv'
